...
public sealed class Win32Keyboard : IKeyboard // Implementation of keyboard input handling using Win32 API
{
    ...
    public bool IsNPressed() => IsDown((int)ConsoleKey.N); // Checks if the N key is pressed
    public bool IsPPressed() => IsDown((int)ConsoleKey.P); // Checks if the P key is pressed
}